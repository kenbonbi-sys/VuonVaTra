...
- Thời điểm: 2026-09-06 19:38:22
- Build: 0.2.0 (development)
- Độ phân giải: 1366 × 768
- Kết quả: **83 đạt, 0 không đạt**


## Khởi động

- ĐẠT — Nạp save và dựng phiên chơi dưới 2 giây · 0.199 s
- ĐẠT — Engine khởi động + splash Unity (chỉ ghi nhận, không phải mục tiêu của game) · 2.03 s
- ĐẠT — Tổng thời gian tới khung hình chơi được · 2.74 s (bao gồm splash)
...
- ĐẠT — Thời gian mô phỏng không lùi · 1196181 → 1196186
...
- ĐẠT — 5 vòng thoát/quay lại không đóng băng khung hình · frame dài nhất 28 ms
- ĐẠT — p95 frame time dưới 16,7 ms khi vườn đầy · trung bình 179 FPS, p95 5.6 ms, 717 khung hình
- ĐẠT — Trung bình đạt 60 FPS · trung bình 179 FPS, p95 5.6 ms, 717 khung hình
...
- ĐẠT — Xuất được dữ liệu test · Đã xuất dữ liệu test: C:/Users/PC/AppData/LocalLow/Vuon va Tra/Vuon va Tra\vuon-nho-export-20260906-193822.log
