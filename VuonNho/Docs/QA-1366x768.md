...
- ĐẠT — Nạp save và dựng phiên chơi dưới 2 giây · 0.174 s
- ĐẠT — Engine khởi động + splash Unity (chỉ ghi nhận, không phải mục tiêu của game) · 2.01 s
- ĐẠT — Tổng thời gian tới khung hình chơi được · 2.70 s (bao gồm splash)
...
- ĐẠT — Xuất được dữ liệu test · Đã xuất dữ liệu test: C:/Users/PC/AppData/LocalLow/Vuon va Tra/Vuon va Tra\vuon-nho-export-20260906-223651.log
