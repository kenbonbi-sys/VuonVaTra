...
- Thời điểm: 2026-09-08 03:09:52
- Build: 0.2.0 (development)
- Độ phân giải: 1366 × 768
- Kết quả: **190 đạt, 1 không đạt**


## Khởi động

- ĐẠT — Nạp save và dựng phiên chơi dưới 2 giây · 0.274 s
- ĐẠT — Engine khởi động + splash Unity (chỉ ghi nhận, không phải mục tiêu của game) · 2.01 s
- ĐẠT — Tổng thời gian tới khung hình chơi được · 2.80 s (bao gồm splash)
...
- ĐẠT — Giữ nguyên số xu sau khi nạp lại · 167 → 167
- ĐẠT — Thời gian mô phỏng không lùi · 5477236 → 5477240
...
- ĐẠT — Nút điều hướng mở upgrade · HudCanvas/FarmHud/LeftRail/UpgradeButton; graphic trên cùng: HudCanvas/FarmHud/LeftRail/UpgradeButton; click handler: HudCanvas/FarmHud/LeftRail/UpgradeButton
- ĐẠT — Mở được bề mặt upgrade
- ĐẠT — Chữ không tràn khỏi ô chứa — upgrade · 87 nhãn
- ĐẠT — Click trên upgrade bị UI chặn, không xuống tới vườn · UI nhận click: UpgradePanel; đối tượng nhận sự kiện pointer: không có; nếu không chặn sẽ trúng WorkshopFence
...
- ĐẠT — Nút điều hướng mở decorate · HudCanvas/FarmHud/LeftRail/DecorateButton; graphic trên cùng: HudCanvas/FarmHud/LeftRail/DecorateButton; click handler: HudCanvas/FarmHud/LeftRail/DecorateButton
...
- ĐẠT — Nút điều hướng mở journal · HudCanvas/FarmHud/LeftRail/JournalButton; graphic trên cùng: HudCanvas/FarmHud/LeftRail/JournalButton; click handler: HudCanvas/FarmHud/LeftRail/JournalButton
- ĐẠT — Mở được bề mặt journal
- ĐẠT — Chữ không tràn khỏi ô chứa — journal · 13 nhãn
- ĐẠT — Click trên journal bị UI chặn, không xuống tới vườn · UI nhận click: JournalPanel; đối tượng nhận sự kiện pointer: không có; nếu không chặn sẽ trúng WorkshopFence
...
- ĐẠT — Chữ không tràn khỏi ô chứa — finance · 37 nhãn
- ĐẠT — Click trên finance bị UI chặn, không xuống tới vườn · UI nhận click: SeedCapital; đối tượng nhận sự kiện pointer: không có; nếu không chặn sẽ trúng WorkshopFence
...
- ĐẠT — Chữ không tràn khỏi ô chứa — agronomy · 104 nhãn
- ĐẠT — Click trên agronomy bị UI chặn, không xuống tới vườn · UI nhận click: SeasonNow; đối tượng nhận sự kiện pointer: không có; nếu không chặn sẽ trúng WorkshopFence
...
- ĐẠT — Chữ không tràn khỏi ô chứa — craft · 42 nhãn
- ĐẠT — Click trên craft bị UI chặn, không xuống tới vườn · UI nhận click: Dial0; đối tượng nhận sự kiện pointer: không có; nếu không chặn sẽ trúng WorkshopFence
...
- ĐẠT — Chữ không tràn khỏi ô chứa — legal · 72 nhãn
- ĐẠT — Click trên legal bị UI chặn, không xuống tới vườn · UI nhận click: LegalStatus; đối tượng nhận sự kiện pointer: không có; nếu không chặn sẽ trúng WorkshopFence
...
- ĐẠT — Chữ không tràn khỏi ô chứa — model · 55 nhãn
...
- ĐẠT — 5 vòng thoát/quay lại không đóng băng khung hình · frame dài nhất 5 ms
- ĐẠT — p95 frame time dưới 16,7 ms khi vườn đầy · trung bình 1496 FPS, p95 0.8 ms, 5983 khung hình
- ĐẠT — Trung bình đạt 60 FPS · trung bình 1496 FPS, p95 0.8 ms, 5983 khung hình
...
- ĐẠT — Không đi xuyên qua đồ đã đặt · dừng cách tâm ghế 65 cm
...
- ĐẠT — Gom đủ xu để xây cả dây chuyền · 12859 / 12780 xu
...
- ĐẠT — Thợ ăn lương và xu vẫn không âm · 4007 xu, 6/6 thợ đang làm
- ĐẠT — Xây dây chuyền xong vẫn kiếm được xu · trước 4079, sau 4007
...
- ĐẠT — Tay thợ chuyển động trong player · lệch nhiều nhất 74.1°
- **KHÔNG ĐẠT** — Rê chuột nhận đủ sáu máy và hiện thông tin · 0/6 máy — cửa sổ không có focus, hover tự tắt; đóng bớt cửa sổ game rồi chạy lại
...
- ĐẠT — Robot mất thời gian đi tới ô · còn 491 ms nữa mới tới ô 4
- ĐẠT — Cây chín nằm chờ chứ không bị thu sạch tức thì · 1 ô đang chín chờ robot
- ĐẠT — Hình robot chạy theo mô phỏng · đi được 386 cm
- ĐẠT — Thu xong thì robot đứng lại ngay ô đó · ô 4
...
- ĐẠT — Bón phân đưa đất về mức tốt nhất và trừ đúng tiền · độ phì 100, còn 4673 xu
...
- ĐẠT — Trị được sâu bệnh và trừ đúng tiền · còn 119710 xu
- ĐẠT — Ô không có sâu thì không cho trị
- ĐẠT — Trồng trái vụ thu ít hơn trồng đúng vụ · 4 → 2 đơn vị
- ĐẠT — Mùa suy ra được từ đồng hồ mô phỏng · đang là mùa hạ
- ĐẠT — Popup ô hiện độ phì, cỏ và mùa · Độ phì 100/100 · cỏ 0/100 · mùa hạ
...
- ĐẠT — Thẻ hồ sơ hiện đúng mùa hiện tại và đồng hồ mùa · Mùa hạ  ·  0:45
...
- ĐẠT — Xuất được dữ liệu test · Đã xuất dữ liệu test: C:/Users/PC/AppData/LocalLow/Vuon va Tra/VuonNho-HudReview\vuon-nho-export-20260908-030952.log
