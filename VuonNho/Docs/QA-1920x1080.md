...
- Thời điểm: 2026-09-06 19:38:33
- Build: 0.2.0 (development)
- Độ phân giải: 1920 × 1080
- Kết quả: **82 đạt, 0 không đạt**


## Khởi động

- ĐẠT — Nạp save và dựng phiên chơi dưới 2 giây · 0.116 s
- ĐẠT — Engine khởi động + splash Unity (chỉ ghi nhận, không phải mục tiêu của game) · 2.01 s
- ĐẠT — Tổng thời gian tới khung hình chơi được · 2.64 s (bao gồm splash)
...
- ĐẠT — Thời gian mô phỏng không lùi · 1196149 → 1196153
...
- ĐẠT — Nhận lệnh đi tới điểm được chỉ · đích (-3.4, 2.2)
...
- ĐẠT — Xuất được dữ liệu test · Đã xuất dữ liệu test: C:/Users/PC/AppData/LocalLow/Vuon va Tra/Vuon va Tra\vuon-nho-export-20260906-193833.log
