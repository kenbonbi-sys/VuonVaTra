...
- Thời điểm: 2026-09-06 21:26:23
- Build: 0.2.0 (development)
- Độ phân giải: 1920 × 1080
- Kết quả: **88 đạt, 0 không đạt**


## Khởi động

- ĐẠT — Nạp save và dựng phiên chơi dưới 2 giây · 0.149 s
...
- ĐẠT — Thời gian mô phỏng không lùi · 1196125 → 1196129
...
- ĐẠT — Click trên inventory bị UI chặn, không xuống tới vườn · UI nhận click: SellAll; đối tượng nhận sự kiện pointer: SellAll; nếu không chặn sẽ trúng Ground
...
- ĐẠT — p95 frame time dưới 16,7 ms khi vườn đầy · trung bình 179 FPS, p95 5.6 ms, 718 khung hình
- ĐẠT — Trung bình đạt 60 FPS · trung bình 179 FPS, p95 5.6 ms, 718 khung hình
...
- ĐẠT — Xuất được dữ liệu test · Đã xuất dữ liệu test: C:/Users/PC/AppData/LocalLow/Vuon va Tra/Vuon va Tra\vuon-nho-export-20260906-212623.log
