...
- ĐẠT — Nạp save và dựng phiên chơi dưới 2 giây · 0.102 s
- ĐẠT — Engine khởi động + splash Unity (chỉ ghi nhận, không phải mục tiêu của game) · 2.01 s
- ĐẠT — Tổng thời gian tới khung hình chơi được · 2.63 s (bao gồm splash)
...
- ĐẠT — Thời gian mô phỏng không lùi · 1196128 → 1196137
...
- ĐẠT — Chữ không tràn khỏi ô chứa — decorate · 20 nhãn
...
- ĐẠT — Chữ không tràn khỏi ô chứa — HUD · 11 nhãn
...
- ĐẠT — Xuất được dữ liệu test · Đã xuất dữ liệu test: C:/Users/PC/AppData/LocalLow/Vuon va Tra/Vuon va Tra\vuon-nho-export-20260906-180320.log
