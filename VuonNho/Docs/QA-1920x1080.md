...
- ĐẠT — Nạp save và dựng phiên chơi dưới 2 giây · 0.181 s
- ĐẠT — Engine khởi động + splash Unity (chỉ ghi nhận, không phải mục tiêu của game) · 2.01 s
- ĐẠT — Tổng thời gian tới khung hình chơi được · 2.71 s (bao gồm splash)
...
- ĐẠT — Thời gian mô phỏng không lùi · 1196136 → 1196140
...
- ĐẠT — Click trên inventory bị UI chặn, không xuống tới vườn · UI nhận click: InventoryPanel; đối tượng nhận sự kiện pointer: không có; nếu không chặn sẽ trúng Tree
...
- ĐẠT — Xuất được dữ liệu test · Đã xuất dữ liệu test: C:/Users/PC/AppData/LocalLow/Vuon va Tra/Vuon va Tra\vuon-nho-export-20260907-004206.log
